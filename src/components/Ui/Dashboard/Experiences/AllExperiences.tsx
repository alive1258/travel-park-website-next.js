...
import { ExperienceItem } from "@/src/types/experienceType";
import { ApiError } from "@/src/types/authType";
import Pagination from "@/src/utils/Pagination";
import {
  useDeleteExperienceMutation,
  useGetAllExperiencesQuery,
} from "@/src/redux/api/experienceApi";
...
const AllExperiences: React.FC = () => {
  ...
  const { data, isLoading, isFetching, refetch } = useGetAllExperiencesQuery({
  ...
  const handleDeleteExperience = async (experience: ExperienceItem) => {
    try {
      const result = await Swal.fire({
        title: "Are you sure?",
        text: `Delete experience "${experience.title}"?`,
        icon: "warning",
      ...
      await Swal.fire({
        icon: "success",
        title: "Deleted!",
        text: `Experience "${experience.title}" has been deleted.`,
        timer: 1000,
      ...
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 p-6 border-b border-gray-200">
        <div>
          ...
          <p className="text-sm text-gray-500">
            Manage the experiences shown on the homepage and experiences page
          </p>
        </div>
        ...
        <div className="flex flex-col sm:flex-row gap-3 w-full lg:w-auto">
          ...
          <Link href="/dashboard/experiences/add-experience">
                ...
                >
                  ...
                  <td className="px-5 py-3">
                    <div className="flex justify-center gap-2">
                      <Link
                        href={`/dashboard/experiences/edit-experience/${experience.id}`}
                      >
                        <button
