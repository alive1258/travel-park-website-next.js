...
import { SustainabilityIntroItem } from "@/src/types/sustainabilityIntroType";
...
const AllSustainabilityIntro: React.FC = () => {
  ...
  const [deleteSustainabilityIntro] = useDeleteSustainabilityIntroMutation();

  const intros: SustainabilityIntroItem[] = data?.data || [];
  ...
  const handleDeleteIntro = async (intro: SustainabilityIntroItem) => {
    try {
      const result = await Swal.fire({
        title: "Are you sure?",
        text: `Delete intro "${intro.heading}"?`,
        icon: "warning",
      ...
      await deleteSustainabilityIntro(intro.id).unwrap();

      await Swal.fire({
        icon: "success",
        title: "Deleted!",
        text: `Intro "${intro.heading}" has been deleted.`,
        timer: 1000,
      ...
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 p-6 border-b border-gray-200">
        <div>
          ...
          <p className="text-sm text-gray-500">
            Manage the &quot;Why It Matters&quot; intro on the Sustainability page
          </p>
        </div>
        ...
        <div className="flex flex-col sm:flex-row gap-3 w-full lg:w-auto">
          ...
          <Link href="/dashboard/sustainability-intro/add-sustainability-intro">
            ...
            {intros?.length > 0 ? (
              intros.map((intro, index) => (
                ...
                >
                  ...
                  <td className="px-5 py-3 text-center">
                    ...
                    >
                      {intro.is_active ? "Active" : "Inactive"}
                    </span>
                  </td>
                  ...
                  <td className="px-5 py-3">
                    <div className="flex justify-center gap-2">
                      <Link
                        href={`/dashboard/sustainability-intro/edit-sustainability-intro/${intro.id}`}
                      >
                        <button
                      ...
                      <button
                        onClick={() => handleDeleteIntro(intro)}
              ...
              <tr>
                <td colSpan={8} className="py-10 text-center text-gray-500">
                  No Sustainability Intro entries found.
                </td>
              </tr>
            )}
          </tbody>
...
export default AllSustainabilityIntro;
