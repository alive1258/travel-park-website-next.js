...
import { DestinationItem } from "@/src/types/destinationType";
...
const AllDestinations: React.FC = () => {
  ...
  const { data, isLoading, isFetching, refetch } = useGetAllDestinationsQuery({
  ...
  const handleDeleteDestination = async (destination: DestinationItem) => {
    try {
      ...
      await Swal.fire({
        icon: "success",
        title: "Deleted!",
        text: `Destination "${destination.name}" has been deleted.`,
        timer: 1000,
      ...
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 p-6 border-b border-gray-200">
        <div>
          ...
          <p className="text-sm text-gray-500">
            Manage the destinations shown on the homepage and destinations
            page
          </p>
        </div>
        ...
        <div className="flex flex-col sm:flex-row gap-3 w-full lg:w-auto">
          ...
          <Link href="/dashboard/destinations/add-destination">
                ...
                >
                  ...
                  <td className="px-5 py-3">
                    <div className="flex justify-center gap-2">
                      <Link
                        href={`/dashboard/destinations/edit-destination/${destination.id}`}
                      >
                        <button
