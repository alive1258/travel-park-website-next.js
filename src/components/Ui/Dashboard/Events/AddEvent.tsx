...
const AddEvent = () => {
  ...
  const onSubmit: SubmitHandler<AddEventFormValues> = async (values) => {
    try {
      await createEvent({
        name: values.name,
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="mt-8 space-y-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <Input
            label="Event Name"
            text="name"
            placeholder="Cannes Yachting Festival"
          ...
          <Input
            label="Date Range"
            text="date_range"
            placeholder="September 8 – 13, 2026"
          ...
          <Input
            label="Location"
            text="location"
            placeholder="Vieux Port & Port Canto, Cannes, France"
          ...
          <div className="col-span-full flex flex-col gap-1">
            ...
            <textarea
              id="description"
              rows={3}
              placeholder="Eco Serenity will be open for private charter previews throughout the festival..."
        ...
        <div className="flex justify-end gap-4 mt-6">
          ...
          <GradientButton
            type="submit"
            text={isLoading ? "Saving..." : "Create Event"}
            icon={Plus}
            disabled={isLoading}
          />
        </div>
