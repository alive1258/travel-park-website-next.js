...
import { InnovationConceptItem } from "@/src/types/innovationConceptType";
...
const AllInnovationConcepts: React.FC = () => {
  ...
  const [deleteInnovationConcept] = useDeleteInnovationConceptMutation();

  const concepts: InnovationConceptItem[] = data?.data || [];
  ...
  const handleDeleteConcept = async (concept: InnovationConceptItem) => {
    try {
      const result = await Swal.fire({
        title: "Are you sure?",
        text: `Delete concept "${concept.name}"?`,
        icon: "warning",
      ...
      await deleteInnovationConcept(concept.id).unwrap();

      await Swal.fire({
        icon: "success",
        title: "Deleted!",
        text: `Concept "${concept.name}" has been deleted.`,
        timer: 1000,
      ...
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 p-6 border-b border-gray-200">
        <div>
          ...
          <p className="text-sm text-gray-500">
            Manage the &quot;Innovation &amp; What&apos;s Next&quot; strip on
            the Fleet page
          </p>
        </div>
        ...
        <div className="flex flex-col sm:flex-row gap-3 w-full lg:w-auto">
          ...
          <Link href="/dashboard/innovation-concepts/add-innovation-concept">
                ...
                >
                  ...
                  <td className="px-5 py-3">
                    <div className="flex justify-center gap-2">
                      <Link
                        href={`/dashboard/innovation-concepts/edit-innovation-concept/${concept.id}`}
                      >
                        <button
...
export default AllInnovationConcepts;
