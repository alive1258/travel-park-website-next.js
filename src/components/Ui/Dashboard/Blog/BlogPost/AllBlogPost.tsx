...
const AllBlogPost: React.FC = () => {
  ...
  const canCreate = hasPermission(permissions, "blog", "create");
  const canUpdate = hasPermission(permissions, "blog", "edit");
  const canDelete = hasPermission(permissions, "blog", "delete");
